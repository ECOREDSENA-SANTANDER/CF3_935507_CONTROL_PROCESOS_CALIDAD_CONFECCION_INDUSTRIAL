...
export default {
  ...
  data: () => ({
    cuestionario: {
      tema: 'Mantenimiento en máquinas de confección.',
      titulo: 'Cuestionario',
      introduccion:
        '<b> Objetivo:</b> evaluar la comprensión de los aprendices sobre los conceptos básicos relacionados con las partes, piezas y mecanismos de las máquinas de confección industrial, la formación de puntadas y costuras según las normas ISO 4915 e ISO 4916, los tipos de mantenimiento, el mantenimiento autónomo, el plan de mantenimiento y el uso de herramientas de apoyo para garantizar la disponibilidad de la maquinaria, la calidad de la costura y la mejora continua en la línea de producción.',
